...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default:   'bg-sky-400 text-zinc-950 hover:bg-sky-300 shadow-lg shadow-sky-400/20',
        outline:   'border border-white/10 bg-transparent text-zinc-300 hover:bg-white/5 hover:text-white hover:border-white/20',
